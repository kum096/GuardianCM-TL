...
export const Footer = () => {
  return (
    <footer className="bg-white py-20 md:py-32 px-6 border-t border-slate-100">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 md:gap-24">
        <div className="flex flex-col gap-6 md:gap-8 md:w-1/3">
      ...
      <div className="max-w-7xl mx-auto mt-20 md:mt-32 pt-12 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
        <p className="text-slate-400 text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] text-center md:text-left">
          © {SITE_CONFIG.year} GuardianCM Tech Labs.
        </p>
        <div className="flex flex-wrap justify-center gap-6 md:gap-10">
           <a href="#" className="text-slate-400 hover:text-slate-900 text-[10px] md:text-xs uppercase tracking-[0.2em] transition-colors font-bold">Privacy Policy</a>
           <a href="#" className="text-slate-400 hover:text-slate-900 text-[10px] md:text-xs uppercase tracking-[0.2em] transition-colors font-bold">Terms of Service</a>
        </div>
      </div>
    </footer>
  );
